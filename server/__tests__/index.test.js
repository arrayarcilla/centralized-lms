...
//   expect(res.body).toEqual({ error: 'Book is not currently available' });
// });
...
//   // Assert the response status code and content
//   expect(res.statusCode).toEqual(500); // Assuming it returns 500 for error
...
//   // Assert the response status code and content
//   expect(res.statusCode).toEqual(500); // Assuming it returns 500 for error
//   expect(res.text).toEqual('Error fetching active transactions');
// });
